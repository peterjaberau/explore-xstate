...
const event = ['START_SCAN', 'RESTART']
    ...
    states: {
      ...
      Scanning: {
        ...
        EvaluatingFiles: {
          invoke: {
            input: {},
            src: "EvaluatingFilesActor",
            id: "evaluatingFiles",
            onDone: [
              {
                target: "MovingFiles",
                actions: {
                  type: "dirsToMoveAction",
                },
              },
            ],
          }
